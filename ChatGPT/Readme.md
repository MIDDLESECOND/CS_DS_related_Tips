# ChatGPT: A Productive Tool for the Foreseeable Future
...
9. <b><span style="color:red">Reverse Engineered ChatGPT API!</span></b> : [https://github.com/acheong08/ChatGPT](https://github.com/acheong08/ChatGPT)
